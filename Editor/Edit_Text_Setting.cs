...
[CustomEditor(typeof(Text_Setting))]
public class Edit_Text_Setting : Editor
{
   

    [Header("Text_Setting")]
    Text_Setting m_Target;

    SerializedProperty m_TextKind;
    ...
    {
        m_TextKind= serializedObject.FindProperty("m_TextKind");
        m_Language_ID = serializedObject.FindProperty("m_Language_ID");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(m_TextKind);
        switch ((E_Text_Kind)m_TextKind.enumValueFlag)
        {
